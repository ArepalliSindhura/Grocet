...
public static Object getObjectByUserPass(String c_email,String password) {
		
		String queryString = "from Customer where c_email = :c_email and password = :password";
		  Query query = sessionFactory.openSession().createQuery(queryString);
		  query.setString("c_email", c_email);
