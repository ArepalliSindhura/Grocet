...
export class EmpService {
  ...
  getAllCustomers() {
    return this.httpClient.get('RestAPI/webapi/myresource/getcustomers').pipe(retry(10));
  }
  getAllOrders() {
    return this.httpClient.get('RestAPI/webapi/myresource/getOrders').pipe(retry(10));
  }


  registerEmp(customer: any) {
    console.log('Inside service...', ' ', customer);
    return this.httpClient.post('RestAPI/webapi/myresource/registerEmp', customer);
  }
  ...
  getEmpByUserPass(c_email: string, password: string): any {
    ...
    return this.httpClient.get('RestAPI/webapi/myresource/getCustomerByUserPass/' + c_email + '/' + password).toPromise();
    }
